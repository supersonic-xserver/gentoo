...
DESCRIPTION="Telegram with custom stealth! Removing tons of redhat BS, deps, and laggy scripts"
HOMEPAGE="https://github.com/supersonic-xserver/ssXchat-desktop"

EGIT_REPO_URI="https://github.com/supersonic-xserver/ssXchat-desktop.git"
inherit git-r3

LICENSE="BSD GPL-3-with-openssl-exception LGPL-2+"
SLOT="0"
KEYWORDS=""
IUSE="dbus enchant +fonts screencast webkit +X"
...
CDEPEND="
	...
	dev-libs/xxhash
	>=dev-qt/qtbase-6.5:6=[dbus?,gui,network,opengl,ssl,widgets]
...
src_configure() {
	...
	local no_webkit_wayland="yes"
	local use_webkit_wayland="no"
	local mycmakeargs=(
		-DQT_VERSION_MAJOR=6
